...
class RelatedVideoAdapter(val context : Context, val mlist : ArrayList<Item>, val mlistener : setOnItemClick) : RecyclerView.Adapter<RelatedVideoAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.publistDetails.setText(mlist.get(position).snippet.channelTitle+" | "+mlist.get(position).snippet.publishedAt)
